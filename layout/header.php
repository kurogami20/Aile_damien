...
<nav class="  relative"> 
 <div class="flex flex-wrap justify-between items-center  "> 
    ...
    <button data-collapse-toggle="mega-menu-full" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-black  min-[1480px]:hidden transform transition-all duration-[1000ms] ease-in-out" aria-controls="mega-menu-full" aria-expanded="false" onclick="classList.toggle('rotate-90')">
    ...
    <div id="mega-menu-full" class="items-center justify-between hidden py-[2rem] w-full  min-[1480px]:flex min-[1480px]:w-auto min-[1480px]:order-1">
        <ul class="flex flex-col min-[1480px]:mt-4  min-[1480px]:flex-row min-[1480px]:mt-0 min-[1480px]:space-x-8 rtl:space-x-reverse gap-5 min-[1480px]:gap-10 ">
            <li class="min-[1480px]:group capitalize text-black text-2xl d min-[1480px]:hover:underline! min-[1480px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1480px]:border-none pb-5 flex justify-between flex-col gap-2" onclick="if (window.innerWidth < 1480) { this.querySelector('ul').classList.toggle('flex!'); }">
            ...
            <?php
                ...
                if (isset($_SESSION['login'])) {
                    echo '<li id="logout" class="min-[1480px]:group capitalize text-black text-2xl d min-[1480px]:hover:underline! min-[1480px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1480px]:border-none pb-5 flex justify-between flex-col gap-2 cursor-pointer ">déconnexion</li>';
