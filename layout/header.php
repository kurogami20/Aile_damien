...
<nav class="   min-[1480px]:h-full max-h-185 "> 
 <div class="flex flex-wrap justify-between items-center  "> 
    ...
    <div id="mega-menu-full" class="items-center justify-between hidden py-[2rem] w-full  min-[1741px]:flex min-[1741px]:w-auto min-[1480px]:order-1 min-[1480px]:h-full h-[125vh] ">
        <ul class="flex flex-col min-[1741px]:mt-4  min-[1741px]:flex-row min-[1741px]:mt-0 min-[1741px]:space-x-8 rtl:space-x-reverse gap-5 min-[1741px]:gap-10 ">
            <li class="group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2" onclick="if (window.innerWidth < 1741) { this.querySelector('ul').classList.toggle('flex!'); }">
              <span class="flex justify-between gap-1 items-baseline">l'association <i class="fa-solid fa-angle-down text-black min-[1741px]:hidden self-right"></i></span>  
                <ul class=" hidden min-[1741px]:flex flex-col gap-6 min-[1741px]:pl-5 min-[1741px]:shadow-lg min-[1741px]:rounded-lg p-5 min-[1741px]:p-10 bg-white min-[1741px]:absolute min-[1741px]:top-[66%] min-[1741px]:max-h-0 min-[1741px]:opacity-0 min-[1741px]:scale-y-75 min-[1741px]:overflow-hidden transform transition-all duration-[1000ms] ease-in-out origin-top min-[1741px]:group-hover:max-h-[1000px] min-[1741px]:group-hover:opacity-100 min-[1741px]:group-hover:scale-y-100">
            ...
            <?php   if (isset($_SESSION['login'])) {
                    echo ' <li class="cursor-pointer min-[1741px]:group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2"><a href="index.php?page=evenements" class="capitalize text-black  hover:underline! hover:text-[#9E6600]!">évènements</a></li>';
                
                }?>
             <li class="group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2" onclick="if (window.innerWidth < 1741) { this.querySelector('ul').classList.toggle('flex!'); }">
              <span class="flex justify-between gap-1 items-baseline">art<i class="fa-solid fa-angle-down text-black min-[1741px]:hidden self-right"></i></span>  
                <ul class=" hidden min-[1741px]:flex flex-col gap-6 min-[1741px]:pl-5 min-[1741px]:shadow-lg min-[1741px]:rounded-lg p-5 min-[1741px]:p-10 bg-white min-[1741px]:absolute min-[1741px]:top-[66%] min-[1741px]:max-h-0 min-[1741px]:opacity-0 min-[1741px]:scale-y-75 min-[1741px]:overflow-hidden transform transition-all duration-[1000ms] ease-in-out origin-top min-[1741px]:group-hover:max-h-[1000px] min-[1741px]:group-hover:opacity-100 min-[1741px]:group-hover:scale-y-100">
            ...
            <li class="group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2" onclick="if (window.innerWidth < 1741) { this.querySelector('ul').classList.toggle('flex!'); }">
              <span class="flex justify-between gap-1 items-baseline">sport <i class="fa-solid fa-angle-down text-black min-[1741px]:hidden self-right"></i></span>  
                <ul class=" hidden min-[1741px]:flex flex-col gap-6 min-[1741px]:pl-5 min-[1741px]:shadow-lg min-[1741px]:rounded-lg p-5 min-[1741px]:p-10 bg-white min-[1741px]:absolute min-[1741px]:top-[66%] min-[1741px]:max-h-0 min-[1741px]:opacity-0 min-[1741px]:scale-y-75 min-[1741px]:overflow-hidden transform transition-all duration-[1000ms] ease-in-out origin-top min-[1741px]:group-hover:max-h-[1000px] min-[1741px]:group-hover:opacity-100 min-[1741px]:group-hover:scale-y-100">
            ...
            <li class="group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2" onclick="if (window.innerWidth < 1741) { this.querySelector('ul').classList.toggle('flex!'); }">
              <span class="flex justify-between gap-1 items-baseline">ensemble <i class="fa-solid fa-angle-down text-black min-[1741px]:hidden self-right"></i></span>  
                <ul class=" hidden min-[1741px]:flex flex-col gap-6 min-[1741px]:pl-5 min-[1741px]:shadow-lg min-[1741px]:rounded-lg p-5 min-[1741px]:p-10 bg-white min-[1741px]:absolute min-[1741px]:top-[66%] min-[1741px]:max-h-0 min-[1741px]:opacity-0 min-[1741px]:scale-y-75 min-[1741px]:overflow-hidden transform transition-all duration-[1000ms] ease-in-out origin-top min-[1741px]:group-hover:max-h-[1000px] min-[1741px]:group-hover:opacity-100 min-[1741px]:group-hover:scale-y-100">
            ...
            <li class="group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2" onclick="if (window.innerWidth < 1741) { this.querySelector('ul').classList.toggle('flex!'); }">
              <span class="flex justify-between gap-1 items-baseline">apprendre <i class="fa-solid fa-angle-down text-black min-[1741px]:hidden self-right "></i></span>  
                <ul class=" hidden min-[1741px]:flex flex-col gap-6 min-[1741px]:pl-5 min-[1741px]:shadow-lg min-[1741px]:rounded-lg p-5 min-[1741px]:p-10 bg-white min-[1741px]:absolute min-[1741px]:top-[66%] min-[1741px]:max-h-0 min-[1741px]:opacity-0 min-[1741px]:scale-y-75 min-[1741px]:overflow-hidden transform transition-all duration-[1000ms] ease-in-out origin-top min-[1741px]:group-hover:max-h-[1000px] min-[1741px]:group-hover:opacity-100 min-[1741px]:group-hover:scale-y-100">
            ...
            <li class="group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2" onclick="if (window.innerWidth < 1741) { this.querySelector('ul').classList.toggle('flex!'); }">
              <span class="flex justify-between gap-1 items-baseline">détente <i class="fa-solid fa-angle-down text-black min-[1741px]:hidden self-right"></i></span>  
                <ul class=" hidden min-[1741px]:flex flex-col gap-6 min-[1741px]:pl-5 min-[1741px]:shadow-lg min-[1741px]:rounded-lg p-5 min-[1741px]:p-10 bg-white min-[1741px]:absolute min-[1741px]:top-[66%] min-[1741px]:max-h-0 min-[1741px]:opacity-0 min-[1741px]:scale-y-75 min-[1741px]:overflow-hidden transform transition-all duration-[1000ms] ease-in-out origin-top min-[1741px]:group-hover:max-h-[1000px] min-[1741px]:group-hover:opacity-100 min-[1741px]:group-hover:scale-y-100">
            ...
            <?php
                ...
                if (isset($_SESSION['login'])) {
                    echo '<li id="logout" class="group capitalize text-black text-2xl d min-[1741px]:hover:underline! min-[1741px]:hover:text-[#9E6600]! border-b-2 border-[#ffbe45] min-[1741px]:border-none pb-5 flex justify-between flex-col gap-2 cursor-pointer ">déconnexion</li>';
