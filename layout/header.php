...
<nav class=" flex! items-center! relative">
    <ul class="flex gap-10">
        <li class="group"><a href="#" class="capitalize text-black! text-2xl hover:underline! hover:text-[#fb8cdf]!">L'association</a>
    <ul class="flex flex-col gap-6  pl-5 shadow-lg rounded-lg p-10  bg-white absolute  hidden group-hover:flex  ">
        ...
        <li class="group"><a href="#" class="capitalize text-black! text-2xl hover:underline! hover:text-[#fb8cdf]!">Art</a>
        <ul class="flex flex-col gap-6  pl-5 shadow-lg rounded-lg p-10  bg-white absolute  hidden group-hover:flex  ">
        ...
        <li class="group"><a href="#" class="capitalize text-black! text-2xl hover:underline! hover:text-[#fb8cdf]!">sport</a>
        ...
        <li class="group"><a href="#" class="capitalize text-black! text-2xl hover:underline! hover:text-[#fb8cdf]!">ensemble</a>
        <ul class="flex flex-col gap-6  pl-5 shadow-lg rounded-lg p-10  bg-white absolute  hidden group-hover:flex  ">
        ...
        <li class="group"><a href="#" class="capitalize text-black! text-2xl hover:underline! hover:text-[#fb8cdf]!">Apprendre</a>
        <ul class="flex flex-col gap-6  pl-5 shadow-lg rounded-lg p-10  bg-white absolute  hidden group-hover:flex  ">
        ...
        <li class="group"><a href="#" class="capitalize text-black! text-2xl hover:underline! hover:text-[#fb8cdf]!">détente</a>
        <ul class="flex flex-col gap-6  pl-5 shadow-lg rounded-lg p-10  bg-white absolute  hidden group-hover:flex  ">
        ...
        <li ><a href="#" class="capitalize text-black! text-2xl hover:underline! hover:text-[#fb8cdf]!">connexion</a>
    </li> 
    </ul>
</nav>
</header>
