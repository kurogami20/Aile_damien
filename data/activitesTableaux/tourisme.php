...
$activiteInfo = [
    ...
    [
        ...
        <p> <span class='font-bold '>Rappel pour les sorties, séjours, visites</span><br>
    ...
    [
        ...
        "description"=>"<p> Le GAV (Groupe d'Activités Voyage) est constitué de bénévoles organisant et animant des voyages à l'étranger.
        Elles gèrent les inscriptions, le planning, les désistements, les réclamations.</p>
        <p> <span class='font-bold'>Organisation</span><br>
        ...
        <p> <span class='font-bold'>Désistement</span><br>
