...
$activiteInfo = [
    ...
    [
        ...
        "activites" => [
            [
                "titre" => "jeux multiples",
                "description" => "<p>Béatrice et Gérard ont le plaisir de partager les lundis après-midi avec les \"joueurs\".<br>Ils apporteront les jeux proposés. La liste de ces jeux peut évoluer selon la demande.<br>A bientôt pour des moments conviviaux.</p>",
                "animateur" => [
                    [
