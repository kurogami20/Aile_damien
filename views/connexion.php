...
<section class="flex flex-col p-4 min-[1480px]:px-40 min-[1200px]:px-20 px-2 gap-15 items-center justify-between ">
    <h2 class="text-3xl sm:text-5xl text-center capitalize font-bold ">Connexion adhérent</h2>
       ...
       <h3 class="text-2xl sm:text-3xl capitalize font-bold mb-5">Identifiez vous</h3>
        <div class="form-control w-full"> 
            <label for="email" class="label ">
                <span class="label-text text-base sm:text-lg ">Utilisateur</span>
            </label>
        ...
        <div class="form-control w-full">
            <label for="password" class="label">
                <span class="label-text text-base sm:text-lg">Mot de passe</span>
            </label>
...
<h3 class="text-2xl sm:text-3xl normal-case  mb-1">Vous n'êtes pas adhérents ?</h3>
    <p class="texte-basesm:text-lg">Vous pouvez adhérer à l'association en remplissant le formulaire d'adhésion.</p>

    <a href="/index.php?page=adherer" > <button type="button" class="sm:self-end w-fit h-fit text-black bg-white hover:underline border border-2 border-[#ffbe46] font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 cursor-pointer" >Adhérer</button></a>
</div>
</section>
