...
<!-- drawer component -->
<div id="drawer-navigation" class=" fixed top-0 mt-[152px] h-screen   z-9! w-64 p-4  transition-transform -translate-x-full bg-white " tabindex="-1" aria-labelledby="drawer-navigation-label">
                              ...
                              <details>
                                   <summary><h3 class="text-xl font-semibold">Les animateurs/rices</h3></summary>
                                    ...
                                    <table class="text-sm  text-gray-500 w-full">
                                        ...
                                        <td class="px-6 py-4">
                                        <?= htmlspecialchars($anim['anim_boitemail']) ?>
                                        </td>
                                        </tr>
                                        <?php endif; ?>
                                        <?php endforeach; ?>
